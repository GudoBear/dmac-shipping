        ...
        <?php if(isset($_GET['error'])): ?>
            <div class="alert-success alert-error">
                <?php
                    ...
                    elseif ($error === 'email') echo 'Invalid email format. Example: name@gmail.com';
        ...
        <div class="wizard-card" style="max-width: 850px; margin: 20px auto;">
            ...
            <form action="process-staff-reg.php" method="POST" style="margin-top: 20px;">
                ...
                <div class="form-row">
                    <div class="form-group">
                        <label>Email *</label>
                        <input type="email" name="emp_email" required placeholder="employee@gmail.com" pattern="^[^\s@]+@[^\s@]+\.[^\s@]{2,}$" title="Please enter a valid email address, example: name@gmail.com">
                    </div>
                    <div class="form-group">
                        <label>Contact Number *</label>
                        <input type="tel" name="emp_contact" required placeholder="09123456789" maxlength="11" minlength="11" inputmode="numeric" pattern="09[0-9]{9}" title="Contact number must be exactly 11 digits and start with 09.">
                    </div>
                </div>
