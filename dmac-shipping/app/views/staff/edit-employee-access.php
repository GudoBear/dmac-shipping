                ...
                <section class="employee-form-card">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group">
                            ...
                            <input type="tel" name="emp_contact" required value="<?= h($employee['emp_contact']) ?>" maxlength="11" minlength="11" inputmode="numeric" pattern="09[0-9]{9}" title="Contact number must be exactly 11 digits and start with 09.">
                        </div>
                    </div>
